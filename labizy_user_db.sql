...
MySQL - 5.5.13 : Database - labizy_user_db
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`labizy_user_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `address_tb` (
  `house_or_flat_number` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `house_or_apartment_name` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `street_address` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `locality_name` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `city_town_or_village` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `state` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `country` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `pin_code` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `landmark` varchar(2000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `contact_tb` (
  `contact_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `contact_type` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `contact_detail` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `user_profile_tb` (
  ...
  `sex` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `date_of_birth` datetime NOT NULL,
  `marital_status` char(20) COLLATE utf8_unicode_ci NOT NULL,
  `profile_picture` varchar(2000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_relationships` (
  `user_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `relation_user_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
